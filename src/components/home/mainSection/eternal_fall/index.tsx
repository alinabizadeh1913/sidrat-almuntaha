...
const EternalFall = ({
  EternalFallContainerRef,
}: {
  EternalFallContainerRef: React.RefObject<HTMLDivElement | null>;
}) => {
  const [active, setActive] = useState<boolean>(true);
  const language = useStore((state) => state.language);

  const { scrollYProgress } = useScroll({
    target: EternalFallContainerRef,
            ...
            <div className="content relative">
              ...
              <div className="content-inner md:ms-[31px] lg:ms-[39px]">
                ...
                <div className="relative z-[50]">
                  ...
                  >
                    <Link href={seasons[5].href} className="block w-fit">
            ...
            <div data-cursor="action">
              <Link href={seasons[5].href}>
                ...
                >
                  ...
                  >
                    <Image
                      src={`${process.env.NEXT_PUBLIC_UPLOADS_BASE_URL}${seasons[5].imageUrls[1]}`}
                      alt={seasons[5].slug}
                      fill
                      objectFit="cover"
                      className="mask-image"
