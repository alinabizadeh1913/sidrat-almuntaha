...
const SuspendedHouse = ({
  SuspendedHouseContainerRef,
}: {
  SuspendedHouseContainerRef: React.RefObject<HTMLDivElement | null>;
}) => {
  const [active, setActive] = useState<boolean>(true);
  const language = useStore((state) => state.language);

  const { scrollYProgress } = useScroll({
    target: SuspendedHouseContainerRef,
  ...
  return (
    <div
      ref={SuspendedHouseContainerRef}
            ...
            <div className="content relative">
              ...
              <div className="content-inner md:ms-[35px] lg:ms-[39px]">
                ...
                <div className="relative z-[50]">
                  ...
                  >
                    <Link href={seasons[3].href} className="block w-fit">
            ...
            <div className="relative z-[50]">
              <Link href={seasons[3].href}>
                ...
                >
                  ...
                  >
                    <Image
                      src={`${process.env.NEXT_PUBLIC_UPLOADS_BASE_URL}${seasons[3].imageUrls[1]}`}
                      alt={seasons[3].slug}
                      fill
                      objectFit="cover"
                      className="mask-image"
